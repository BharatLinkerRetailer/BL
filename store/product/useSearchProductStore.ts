// stores/product/useSearchProductStore.ts
...
type SearchProductStore = SearchProductState & SearchProductActions;

// ─── Initial State ───────────────────────────────────────────────────────────

const INITIAL_STATE: SearchProductState = {
  entries: [],
  lastDoc: null,
  hasMore: true,
  status: "idle",
...
export const useSearchProductStore = create<SearchProductStore>((set, get) => ({
  ...INITIAL_STATE,
